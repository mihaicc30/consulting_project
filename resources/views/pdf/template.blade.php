...
<body class="bg-gray-200">
    <h2 class="text-[4rem] text-gray-600 font-semibold mb-4 text-center">
        Generate Receipt
    </h2>
    <div class="bg-white rounded-xl p-6 mx-[250px]">
        ...
        <div>
            <div class="grid grid-cols-1 lg:grid-cols-5">
                ...
                <div class="font-bold text-sm bg-gray-100">
                    FILE SIZE
                </div>
                <div class="font-bold text-sm bg-gray-100">TIME SENT</div>
                <div class="font-bold text-sm bg-gray-100">
                    TIME RECEIVED
                </div>
                <div class="font-bold text-sm bg-gray-100">TIME OPEN</div>
                @if(isset($items))
                @foreach ($items as $item)
                <div class="flex-grow overflow-hidden">
                    {{ $item->file_name }}
                </div>
                <div>{{ $item->file_size_original }}</div>
                <div>{{ $item->time_send_start }}</div>
                <div>{{ $item->time_recv_end }}</div>
                <div>
                    {{
                    $item->time_post_opened
                        ? $item->time_post_opened
                        : "Not opened"
                }}
                </div>
            ...
            <div class="flex">
                <div class="w-1/2">
                    <h3 class="text-lg font-semibold mb-2 bg-gray-100 mr-2">RECEIVER</h3>
                    <p>
                        {{ $item->receiver_ezepost_addr }}
                        <hr class="mb-2" />
                    </p>
                    <p>
                    ...
                    <p>
                        {{ $item->receiver_displayname }}
                        <hr class="mb-2" />
                    </p>
                    <p>
                        {{ $item->receiver_prv_ip }}
                        <hr class="mb-2" />
                    </p>
                    <p>
                        {{ $item->receiver_prv_port }}
                        <hr class="mb-2" />
                    </p>
                    <p>
                        {{ $item->receiver_pub_ip }}
                        <hr class="mb-2" />
                    </p>
                    <p>
                        {{ $item->receiver_pub_port }}
                        <hr class="mb-2" />
                    </p>
                    <p>
                        {{ $item->receiver_OS }}
                    ...
                    <p>
                        {{ $item->receiver_OS_version }}
                        <hr class="mb-2" />
                    </p>
                    <p>
                        {{ $item->receiver_mac_addr }}
                        <hr class="mb-2" />
                    </p>
                    <p>
                        {{ $item->receiver_device_name}}
                        <hr class="mb-2" />
                    </p>
                    <p>
                        {{ $item->receiver_username }}
                ...
                <div class="w-1/2">
                    <h3 class="text-lg font-semibold mb-2 bg-gray-100">SENDER</h3>
                    <p>
                    ...
                    <p>
                        {{ $item->sender_OS_version }}
                        <hr class="mb-2" />
                    </p>
                    <p>
                        {{ $item->sender_mac_addr }}
                        <hr class="mb-2" />
                    </p>
                    <p>
                        {{ $item->sender_device_name }}
                        <hr class="mb-2" />
                    </p>
                    <p>
                        {{ $item->sender_username }}
