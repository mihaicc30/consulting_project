<!-- QRCODE Modal - START -->
<div id="modalOverlay" class="fixed inset-0 bg-[#000000de] z-50 transition" :class="{ 'hidden' : false}" x-show="isModal">
    <div class="modalContainer animate-fadeIN transition mx-auto flex w-[90svw] h-[96svh] flex-col" :class="{ 'hidden' : false}" x-show="isModal">
