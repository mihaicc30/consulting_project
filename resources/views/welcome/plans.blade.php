...
<div class="relative flex flex-col h-1/2 bg-[url('/herovideo.mp4')]">
  ...
  <div class="overlay relative flex flex-col pb-4">
    ...
    <div x-data="{ isActive: false }" class="sm:hidden flex justify-end fixed right-0 z-30" >
      ...
      <div class="grid grid-cols-2 justify-items-center gap-4 absolute top-[100%] p-4 right-0 bg-[#ffebde] w-[100vw]" x-show="isActive">
        ...
        <a @click="isActive = !isActive" href="/plans" class="active h-16 w-[40vw] text-center flex items-center justify-center text-xl font-bold shadow-xl border-b-2 border-b-[--c2] hover:bg-[--c2] transition rounded">Plans</a>
        ...
        <div class="flex flex-col text-center flex-nowrap ">
            ...
            <div class="flex flex-nowrap gap-8 m-4 min-w-[860px]">
                <div class="flex flex-col shadow-xl p-4 z-10 relative min-w-[160px] flex-nowrap">
                    ...
                    <p class="text-3xl font-bold">As Needed</p>
                    <p class="border-b-2 my-4"></p>
