  ...
  <div class="overlay relative flex flex-col">
    ...
    <div x-data="{ isActive: false }" class="sm:hidden flex justify-end fixed right-0 z-30">
      ...
      <div class="grid grid-cols-2 justify-items-center gap-4 absolute top-[100%] p-4 right-0 bg-[#ffebde] w-[100vw]" x-show="isActive">
        ...
        <a @click="isActive = !isActive" href="/about" class="active h-16 w-[40vw] text-center flex items-center justify-center text-xl font-bold shadow-xl border-b-2 border-b-[--c2] hover:bg-[--c2] transition rounded">About</a>
      </div>
