...
<div class="relative flex flex-col h-1/2 bg-[url('/herovideo.mp4')]">
  ...
  <div class="overlay relative flex flex-col">
    ...
    <div x-data="{ isActive: false }" class="sm:hidden flex justify-end fixed right-0 z-30">
      <button class="sm:hidden max-sm:flex relative justify-end mt-6 bg-[#ffffffc4] p-4" @click="isActive = !isActive" :class="{ 'active': isActive }">
      ...
      <div class="grid grid-cols-2 justify-items-center gap-4 absolute top-[100%] p-4 right-0 bg-[#ffebde] w-[100vw]" x-show="isActive">
        ...
        <a @click="isActive = !isActive" href="/services" class="active h-16 w-[40vw] text-center flex items-center justify-center text-xl font-bold shadow-xl border-b-2 border-b-[--c2] hover:bg-[--c2] transition rounded">Services</a>
    ...
    <div class="max-sm:hidden flex relative justify-end mt-6 bg-[#ffffffc4]">
      <ul class="z-20 flex gap-4 pr-4 py-2">
        ...
        <a class="p-2 relative navButton font-[600]" href="/services">
          <span class="absolute bg-white inset-0 z-10 rounded active"></span>
...
<div class="relative mt-12 text-white bg-[url('/9.jpg')]">
  <div class="overlay z-20 inset-0 flex flex-col relative">
    <div class="grid grid-cols-4 mx-4 mt-4 z-30 max-sm:grid-cols-2 max-[400px]:grid-cols-1">
      <div class="flex flex-col p-2 gap-4 text-xs">
        <div>
          <svg class="block h-8 w-auto grow mt-2 max-sm:h-8" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 131.4 80" style="enable-background: new 0 0 131.4 80" xml:space="preserve">
            <style type="text/css">
              .st0 {
                fill: #e53323;
              }
            ...
            <path style="
                            ...
                            " d="M57.7,51.3c-1.3,0-2.5-0.5-3.4-1.5  c-1.6-1.9-1.4-4.7,0.5-6.3l25.7-22.2c2.8-2.4,3.1-6.6,0.7-9.5c-2.4-2.8-6.6-3.1-9.5-0.7L45.7,33.6c-4.2,3.6-4.7,10-1.1,14.2  c2,2.3,4.8,3.5,7.6,3.5L57.7,51.3z"></path>
            ...
            <path style="
                            ...
                            " d="M85.7,3.5c-2-2.3-4.8-3.5-7.6-3.5H54.8  c1.9,1.6,3,4,3,6.7c0,2.7-1.2,5.1-3,6.7l22.8,0c1.3,0,2.5,0.5,3.4,1.6c1.6,1.9,1.4,4.7-0.5,6.3l4.1-3.6C88.9,14.1,89.4,7.7,85.7,3.5  z"></path>
            <g>
        ...
        <p class="inline-flex items-center"><svg width="34px" height="34px" viewBox="-6.72 -6.72 45.44 45.44" enable-background="new 0 0 32 32" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000">
            ...
            <g id="SVGRepo_iconCarrier">
              ...
              <g id="Maps_2_"></g>
              <g id="Maps_1_">
                <path d="M16,1C10.49,1,6,5.5,6,11.04c0,5.25,8.34,13.72,9.29,14.67C15.49,25.9,15.74,26,16,26s0.51-0.1,0.71-0.29 C17.66,24.76,26,16.29,26,11.04C26,5.5,21.51,1,16,1z" fill="#ffbb00"></path>
                <path d="M20,11.04c0,2.2-1.79,4-4,4s-4-1.8-4-4c0-2.21,1.79-4,4-4S20,8.83,20,11.04z" fill="#f58a8a"></path>
                <g>
                  <path d="M16,31c-0.2354,0-0.4595-0.0005-0.6943-0.0107C8.21,30.8652,1,28.5957,1,24.5 c0-2.0806,1.9492-3.8872,5.4893-5.0874c0.5225-0.1748,1.0903,0.103,1.2681,0.6265c0.1772,0.5229-0.103,1.0903-0.6265,1.2681 C4.583,22.1709,3,23.394,3,24.5c0,2.0215,5.0791,4.3623,12.3677,4.4902C15.5986,29,15.7925,29.001,16,29 c0.208,0,0.4009,0,0.6055-0.0088C23.9209,28.8623,29,26.5215,29,24.5c0-1.106-1.583-2.3291-4.1309-3.1929 c-0.5234-0.1777-0.8037-0.7451-0.6265-1.2681c0.1777-0.5234,0.7451-0.8022,1.2681-0.6265C29.0508,20.6128,31,22.4194,31,24.5 c0,4.0957-7.21,6.3652-14.3325,6.4902C16.4595,30.9995,16.2354,31,16,31z" fill="#f58a8a"></path>
                </g>
              </g>
              <g id="Maps"></g>
            </g>
          </svg> Birmingam, B12DA</p>
        <div class="flex gap-4">
          <span class="w-8 h-8 rounded cursor-pointer hover:translate-y-1 transition"><svg viewBox="0 0 14 14" role="img" focusable="false" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="#000000">
              <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
              <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
              <g id="SVGRepo_iconCarrier">
                <path fill="#485a96" d="M12.3377569 13.000045c.36572 0 .662243-.2965683.662243-.66228789V1.6622429c0-.3658549-.296568-.6622879-.662243-.6622879H1.66228797c-.36585448 0-.66228788.296478-.66228788.6622879v10.67546925c0 .36576455.2964334.66228785.66228788.66228785H12.3377569z"></path>
                <path fill="#ffffff" d="M9.2798126 13.000045V8.3529692h1.5598161l.2335322-1.8110629H9.2797676V5.3856227c0-.5243449.1455865-.8816567.8975283-.8816567l.958991-.0004496V2.8837212c-.165864-.022031-.735171-.071354-1.3974139-.071354-1.3827115 0-2.329338.8439787-2.329338 2.3939481v1.3355914H5.8457173v1.8110629H7.409535v4.6470308h1.8702776z"></path>
              </g>
            </svg></span>
          <span class="w-8 h-8 rounded cursor-pointer hover:translate-y-1 transition"><svg viewBox="0 0 24 24" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:cc="http://creativecommons.org/ns#" xmlns:dc="http://purl.org/dc/elements/1.1/" fill="#000000">
              <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
              <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
              <g id="SVGRepo_iconCarrier">
      ...
      <div class="flex flex-col p-2">
        ...
        <a href="#" class="inline-flex"><span><svg width="24px" height="24px" viewBox="-4.8 -4.8 57.60 57.60" fill="none" xmlns="http://www.w3.org/2000/svg" transform="rotate(0)">
              <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
              <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC" stroke-width="0.384"></g>
              <g id="SVGRepo_iconCarrier">
                <rect width="48" height="48" fill="white" fill-opacity="0.01"></rect>
                <path d="M24 44C35.0457 44 44 35.0457 44 24C44 12.9543 35.0457 4 24 4C12.9543 4 4 12.9543 4 24C4 35.0457 12.9543 44 24 44Z" fill="#ff6666" stroke="#000000" stroke-width="0.9120000000000001" stroke-linejoin="round"></path>
                <path d="M14.4917 24.5H32.4917" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
      ...
      <div class="flex flex-col p-2">
        ...
        <input type="text" class="rounded p-2" placeholder="Your Email" />
    ...
    <div class="flex flex-wrap justify-around p-4">
      <div class="flex flex-wrap gap-2 items-baseline">
        <p>Partners:</p>
        <span class="w-8 h-8 rounded cursor-pointer hover:translate-y-1 transition"><svg viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000">
            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
            <g id="SVGRepo_iconCarrier">
        ...
        <span class="w-8 h-8 rounded cursor-pointer hover:translate-y-1 transition"><svg viewBox="-4 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000">
            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
            <g id="SVGRepo_iconCarrier">
              ...
              <g id="layer1" transform="translate(12.495 6.756)">
                <g id="g4182">
                  <g id="g5747" transform="translate(81.631 113.771) scale(.29074)">
                    <path id="path4155" class="st0" d="M-52.5-412.3l-.3 168-.3 168-13.8-39v-.1l-17.9 374c17.6 49.6 27 76.1 27.1 76.2.1.1 10.1.7 22.2 1.3 36.6 1.8 82 5.7 116.5 10 8 1 14.8 1.5 15.3 1.1s.6-171.4.5-380.1l-.3-379.4h-149z"></path>
                    <path id="path4157" class="st0" d="M-322-412.8V-33c0 208.9.2 380 .5 380.3.3.3 13.2-1 28.8-2.7 15.6-1.7 37.1-3.9 47.8-4.8 16.4-1.4 65.6-4.5 71.2-4.6 1.7 0 1.8-8.5 2-160.9l.3-160.9 11.9 33.6c1.8 5.2 2.4 6.8 4.2 11.9l17.9-373.9c-3.8-10.7-1.8-5.1-6.1-17.3-14.6-41.3-27-76.2-27.5-77.8l-1-2.8h-150z"></path>
                    <path id="path5715" class="st0" d="M-52.5-412.3l-.3 168-.3 168-13.8-39v-.1l-17.9 374c17.6 49.6 27 76.1 27.1 76.2.1.1 10.1.7 22.2 1.3 36.6 1.8 82 5.7 116.5 10 8 1 14.8 1.5 15.3 1.1s.6-171.4.5-380.1l-.3-379.4h-149z"></path>
                    <path id="path5717" class="st0" d="M-322-412.8V-33c0 208.9.2 380 .5 380.3.3.3 13.2-1 28.8-2.7 15.6-1.7 37.1-3.9 47.8-4.8 16.4-1.4 65.6-4.5 71.2-4.6 1.7 0 1.8-8.5 2-160.9l.3-160.9 11.9 33.6c1.8 5.2 2.4 6.8 4.2 11.9l17.9-373.9c-3.8-10.7-1.8-5.1-6.1-17.3-14.6-41.3-27-76.2-27.5-77.8l-1-2.8h-150z"></path>
                    ...
                    <path id="path5721" class="st2" d="M-322-412.8l150.5 426.5v-.2l11.9 33.6C-93.5 234.2-58 334.6-57.8 334.8c.1.1 10.1.7 22.2 1.3 36.6 1.8 82 5.7 116.5 10 7.9 1 14.8 1.5 15.2 1.1L-53.1-76.4v.1l-13.8-39c-13.5-38.1-22.5-63.6-76.8-217-14.6-41.3-27-76.2-27.5-77.8l-1-2.8h-74.9l-74.9.1z"></path>
                  </g>
                </g>
              </g>
            </g>
