...
<div class="relative flex flex-col h-1/2 bg-[url('/herovideo.mp4')]">
    ...
    <div class="overlay relative flex flex-col">
        ...
        <!-- Mobile Navbar START -->
        <div class="sm:hidden flex justify-end fixed right-0 z-30 w-[100vw]" x-data="{ isActive: false }">
                ...
                <g id="SVGRepo_iconCarrier">
                  ...
                  <defs>
                    <linearGradient x1="50%" y1="0%" x2="50%" y2="99.0447173%" id="linearGradient-1">
                      ...
                      <stop stop-color="#FFC44D" offset="100%"> </stop>
                    </linearGradient>
                  </defs>
            ...
            <div  class="grid grid-cols-2 justify-items-center gap-4 absolute top-[100%] p-4 left-0 right-0 bg-[#ffebde]"
                x-show="isActive">
