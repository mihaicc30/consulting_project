    ...
    <div class="widget flex flex-col col-span-2 border-2 border-[#e6e6e6] rounded-lg">
      <div class="grid w-[100%] ">
        ...
        <p class="text-center mx-auto font-bold border-b-2">
          <span title="Unread" class="font-bold text-xl">{{ $contactMessages->where('status', 'unread')->count() }}</span>
          <span>/</span>
          <span class="text-xs" title="Read">{{ $contactMessages->count() }}</span> Messages
        </p>
