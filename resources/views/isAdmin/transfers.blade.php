  ...
  <div class="grid grid-cols-1 grow" x-data="{ isModal: false }">
    ...
    <div class="flex flex-col py-6 border-2 border-[#e6e6e6] rounded-lg">
      ...
      <div class="widget col-span-2 flex flex-col ">
              ...
              <div class="flex flex-wrap transition-all gap-4 justify-center">
                ...
                <div class="{{ $receipt->deleted_at !== null ? 'grayscale' : '' }} basis-[23%] p-2 flex flex-col max-w-[23%] shadow-xl rounded transition-all duration-500 hover:scale-[.98]">
                  ...
                  <div class="flex flex-nowrap justify-end ">
                    ...
                    <a title="Generate Receipt" class="w-[40px] h-[50px]" href="{{ route('pdf.view', ['item' => json_encode($receipt['id'])]) }}" target="_blank">
        ...
        <form target="_blank" method="GET" action="{{ route('pdf.view') }}" class="receiptGeneratorContainer fixed text-center bottom-0 h-[40svh] bg-white z-50 transition  flex-col gap-4 items-center p-2 border-2 border-black" style="width:150px;" :style="'right:' + rightValue" x-data="{ rightValue: '-190px' }">
