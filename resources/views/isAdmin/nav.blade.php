 <!-- Navbar START -->
<div x-data="{ isActive: true }" x-bind:class="{'basis-[10%]  min-w-[110px]': isActive, 'basis-[4%]': !isActive}" class="relative">
 <button class="max-sm:flex bg-[#ffffffc4] p-2 h-[40px] w-[40px] fixed top-[88px] z-50" @click="isActive = isActive == true ? false: true" :class="{ 'active': isActive }">
