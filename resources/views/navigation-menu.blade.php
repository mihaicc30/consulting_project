<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 dark:bg-gray-800 flex flex-col h-[100vh]">
        ...
        <div class="flex flex-col h-[100vh] gap-4">
            ...
            <div class="shrink-0 flex flex-col items-center">
                <a href="{{ route('dashboard') }}">
                    <x-jet-application-mark class="block h-20 w-auto grow" />
                </a>
            </div>

            <!-- Navigation Links -->
            <div class="hidden shrink-0 sm:-my-px sm:flex flex-col gap-4">
