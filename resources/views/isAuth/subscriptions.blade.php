...
<div class="grow">
  ...
  <div class="relative flex flex-col h-100 overflow-hidden">
    ...
    <div class="overlay relative flex flex-col">
      ...
      <div class="my-8 text-center">
        <h1 class="font-bold text-3xl">Subscriptions</h1>
          ...
          <div class="grid grid-cols-3 gap-8 m-4 min-w-[860px]">
            ...
            <div class="flex flex-col shadow-xl p-4 z-10 relative min-w-[160px] flex-nowrap">
              ...
              <div class="flex flex-col items-start  text-start grow">
                ...
                @if (strlen($option) > 0 )
                <p class="grid grid-cols-[24px_1fr]" :class="{ 'popular': '{{ $plan['name'] }}'.endsWith('Basic') }">
  ...
  <div class="bg-gray-100 p-4 text-center">
    <p class="text-gray-700 dark:text-gray-300">
      <strong class="text-2xl text-red-500">Cancelation Policy</strong> <br>
    <ul>
      <li>You can cancel your subscription at any time. </li>
      <li>You will still have access to your account until the end of your billing period. </li>
      <li>The cancellation process can only be done from your <strong class="text-xl">Customer Portal.</strong></li>
    </ul>
    </p>
  </div>
