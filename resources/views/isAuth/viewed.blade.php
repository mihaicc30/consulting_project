      ...
      <div class="accordion-content transition">
        <div class="relative flex flex-col flex-nowrap p-2">
          ...
          <p>Search {{ $totalFiles }} Files</p>
            <form method="GET" action="/portal/viewed?page=' + page">
              <input type="text" name="query" class="rounded-l p-2 w-[90%] text-black border-[1px] border-black/30" placeholder="File name" value="{{ request('query') }}">
